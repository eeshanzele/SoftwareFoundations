...
Proof.
  intros n m A B. induction B.
    - simpl in A. apply A. 
    - apply IHB. simpl in A. inversion A. apply H0. 
Qed.
...
Proof.
  intros n m p q H. induction n. 
    - simpl in H. left. apply O_le_n. 
    - destruct IHn. 
      + apply le_S in H. simpl in H. apply Sn_le_Sm__n_le_m in H.
        apply H. 
      + right. 
Admitted.
...
(** The interesting cases are those that correspond to [Star].  Note
  ...
  - (* MStar0 *)
    injection Heqre' as Heqre''. intros s H. assumption.
...
Proof.
  intros P b H. destruct H.  
    - split. 
        ...
        + intros B. apply H.
    - split. 
        + intros A. apply H in A. destruct A.
        + intros B. discriminate B. 
Qed.
