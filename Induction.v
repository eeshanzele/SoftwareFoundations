...
Proof.
intros n. induction n as [| n' BaseCase].
...
intros m. induction m as [|m' IHm'].
  simpl. rewrite add_0_r. reflexivity.
  simpl. assert(H_pred: forall a b, a = b -> S a = S b). { admit. }
  apply H_pred. Search (_ + _ = _). Admitted.
...
intros m n. 
  induction m as [|m' IHm'].
    ...
    - reflexivity. 
    - simpl. rewrite <- IHn'. reflexivity.
    - simpl. rewrite -> IHm'. rewrite <- mult_comm_lemma. reflexivity. 
  Qed. 
...
Example double_bin_zero : double_bin BZ = BZ.
